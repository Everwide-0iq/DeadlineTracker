...
- Card CRUD: create, edit, mark done/reopen, delete, resize from content, attach one compressed image/screenshot, and connect cards with visual arrows.
...
- CRUD карточек: создать, редактировать, отметить готово/вернуть в работу, удалить, автоматически расширять под контент, прикреплять одно сжатое изображение/скриншот и связывать карточки визуальными стрелками.
