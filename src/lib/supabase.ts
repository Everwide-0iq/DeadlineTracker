...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      set_card_reminders: { Args: { target_card: string; selected_offsets: number[]; custom_time: string | null; time_zone: string; reminder_language: string; reminder_note: string }; Returns: Json }
      ...
      submit_arcade_score: {
        Args: { target_team_id: string; game_mode: 'snake' | 'shooter' | 'rogue' | 'platformer'; run_token: string; final_score: number; duration_ms: number }
        Returns: number
      }
